      ...
      <div className="absolute top-24 left-5 z-20 flex flex-col gap-3">
        <div className=" flex gap-2 items-center">
          <div className="w-fit">
            <Image
              alt="finish"
              src="/assets/img/icon-finish.png"
              width={16}
              height={12}
              priority
            />
          </div>
          <span className="font-cubano outline-title text-white text-2xl italic">
            {totalTrue}/{totalTask}
          </span>
          <span className="font-cubano outline-title text-kuning -rotate-6 text-sm shadow-md relative -left-6 top-4">
            benar
          </span>
        </div>
        <div className=" flex gap-2 items-center">
          ...
          <span className="font-cubano outline-title text-white text-2xl italic">
            {parseFloat((time / 1000).toFixed(1))} Detik
          </span>
        </div>
      </div>
    );
    ...
    if (isLolos) {
      if (mode === "easy") {
        return (
          <div className="absolute top-20 right-2 z-20 flex flex-col gap-3">
            <Image
              alt="tropi perunggu"
              src="/assets/img/icon-tropi-perunggu.png"
              width={90}
              height={112}
              priority
            />
      ...
      if (mode === "medium") {
        return (
          <div className="absolute top-20 right-2 z-20 flex flex-col gap-3">
            <Image
              alt="tropi perak"
              src="/assets/img/icon-tropi-perak.png"
              width={90}
              height={112}
              priority
            />
      ...
      if (mode === "hard") {
        return (
          <div className="absolute top-20 right-2 z-20 flex flex-col gap-3">
            <Image
              alt="tropi emas"
              src="/assets/img/icon-tropi-emas.png"
              width={90}
              height={112}
              priority
            />
      ...
      return (
        <div className="absolute top-20 right-2 z-20 flex flex-col gap-3">
          <Image
            alt="tropi failed"
            src="/assets/img/icon-tropi-failed.png"
            width={90}
            height={112}
            priority
          />
