        ...
        <div className='flex flex-col gap-4'>
            <div className='flex justify-between items-center'>
                <motion.div
                    ...
                    <Image src="/assets/img/icon-time.png" width={20} height={24} className="relative left-7" alt="icon time" />
                ...
                className='flex gap-2 mt-6 mr-3'>
                    <div className='bg-container-level shadow-md w-20 h-6 bg-cover rounded-md bg-no-repeat bg-center relative flex justify-end'>
                        <Image src="/assets/img/icon-level.png" width={33} height={22} className="absolute -top-1 left-1.5" alt="icon level" />
                        <span className='text-white font-cubano outline-title relative right-5'>4</span>
                    </div>
                    <div className='bg-container-level shadow-md w-20 h-6 bg-cover rounded-md bg-no-repeat bg-center relative flex justify-end'>
                        <Image src="/assets/img/icon-stars.png" width={26} height={21} className="absolute -top-2 left-2" alt="icon stars" />
            ...
            <div className='flex justify-between items-center mx-3 mt-4'>
                <motion.div
                    ...
                    <Image src="/assets/img/btn-setting.png" width={34} height={34} className="active:scale-90 duration-100 cursor-pointer" alt="btn setting" />
                    <Image src="/assets/img/btn-sound.png" width={34} height={34} className="active:scale-90 duration-100 cursor-pointer" alt="btn sound" />
                </motion.div>
                <motion.div 
                  initial={{ x:"200%" }}
                  animate={{ x:"0%" }}
                className='bg-profildev bg-right bg-contain bg-no-repeat w-24 h-10 relative active:scale-90 duration-100 cursor-pointer'>
                    <Image src="/assets/img/icon-dev.png" width={20} height={30} className="absolute right-2 -top-4" alt="icon dev" />
