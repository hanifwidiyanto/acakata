            ...
            >
                ...
                <div className='px-6 pt-2 flex justify-between w-full'>
                    ...
                    <div className='active:scale-90 duration-100 cursor-pointer'>
                        <button type='button' className='bg-btn-nologin font-cubano w-[70px] h-[24px] bg-contain bg-no-repeat bg-center text-center grid place-content-center text-white outline-title  text-sm'>daftar</button>
                    </div>
                </div>
            </motion.div>
        </>
