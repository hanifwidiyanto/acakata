    ...
    <motion.div
      ...
      <div className='mx-14 w-full pt-4'>
        <div className="flex flex-col w-full items-center">
          ...
          <span className='font-cubano text-white outline-title text-2xl'>2023</span>
        </div>
                ...
                <div
                  ...
                  <div className='min-h-[48px] min-w-[48px]'>
                    <Image
                      ...
                      width={48}
                      height={48}
                      layout='responsive' priority className='rounded-md' />
                  </div>
                  <span className='text-xl font-cubano text-white outline-title'>{e.name}</span>
                </div>
                <div className='flex flex-col w-full justify-between items-end'>
                  <div className='flex gap-2 items-center'>
                    <span className='italic text-white text-lg font-cubano outline-title'>level</span>
                    <span className='text-kuning text-2xl font-cubano outline-title italic'>{e.level}</span>
                  </div>
                  <div className='flex gap-2 items-center'>
                    <Image src="/assets/img/icon-stars.png" alt='icon stars' width={40} height={32} priority />
                    <span className='text-kuning text-2xl font-cubano outline-title italic'>{e.totalStars}</span>
                  </div>
                </div>
              </div>
            </div>
